...
//
//
//    @MessageMapping("/comments/{commentId}")
//    @SendTo("/topic/comments/{commentId}")
//    public CommentDto getRepliesForComment(@PathVariable Long commentId) {
//        // Здесь вы можете реализовать логику получения комментариев в реальном времени
//        // и возвращать их через WebSocket
//        CommentDto commentDto = /* Логика получения комментариев */;
//        return commentDto;
//    }
//
//
